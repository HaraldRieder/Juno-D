========================================================================
       KONSOLENANWENDUNG : Juno_Dynamik
========================================================================


Diese Juno_Dynamik-Anwendung hat der Anwendungs-Assistent für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, die Ihre Juno_Dynamik-Anwendung bilden.
...
StdAfx.h, StdAfx.cpp
    ...
    Juno_Dynamik.pch und einer vorkompilierten Typdatei namens StdAfx.obj verwendet.
